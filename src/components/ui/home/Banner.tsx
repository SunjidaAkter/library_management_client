    ...
    <div className="">
      <div className="lg:m-10 mx-10 my-5 lg:px-24 px-10 md:pt-24 md:pb-16 pt-8 pb-8 lg:flex lg:flex-row md:flex md:flex-col-reverse flex flex-col-reverse justify-center items-center bg-white rounded-lg shadow-lg">
        <div className="lg:pl-16 px-0 lg:mt-[-50px] md:mt-[50px] mt-[30px] lg:w-[48%] md:w-full w-full">
          <p className="leading-none text-[50px] md:text-[70px] lg:text-[90px] lg:text-start md:text-center text-center font-thin text-black lilita">
            New & Trendy{" "}
          </p>
          <p className="lg:text-4xl md:text-[25px] text-[20px] text-center lg:text-start md:mt-10 mt-5 md:mb-7 mb-3 font-thin text-black caveat">
            Explore New Books Everyday
          </p>
          <NavLink to="/books">
            <div className="lg:flex lg:justify-start md:flex md:justify-center flex justify-center">
              <button className="shadow-[10px_10px_10px_0px_rgba(0,0,0,0.25)] btn btn-md border-[2px] group hover:border-[#8387162] uppercase caveat font-semibold mt-4 hover:bg-[#837162]  hover:text-[white]  text-black text-[20px]">
                Find Your Favourite
                <CgArrowLongRight className="text-[30px] group-hover:text-[white] text-black" />
              </button>
            </div>
          </NavLink>
        </div>
        <div className="lg:w-[50%] md:w-[50%] w-full">
          ...
          <p className="lg:text-5xl md:text-[35px] text-[20px] text-center font-medium text-black caveat">
