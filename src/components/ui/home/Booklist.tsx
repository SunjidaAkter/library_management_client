        ...
        <ul className="space-y-2">
          ...
          <li>
            <p
              ...
              className={`text-center my-3 caveat text-[25px] text-black hover:underline ${
                  ...
                  <div className="w-[90%] mx-auto md:mt-5 mt-5 mb-5 bg-white px-1 pt-12  relative shadow-[10px_10px_10px_0px_rgba(0,0,0,0.25)] flex flex-col rounded-lg justify-between ">
                    ...
                    <div className="py-4 px-6">
                      ...
                      <div className="flex justify-between items-center ">
                        <p className="uppercase text-[28px] caveat  text-black">
                          {book?.title}
                        </p>
                        <div className="absolute top-0 right-2  text-black text-[45px] caveat ">
                          ${book?.price}
                        </div>
                        <div className="badge bg-black text-white text-xs">
                          {genreName?.name}
                        </div>
                      </div>
                      <p className="footer-title text-[20px]  text-black caveat mb-5">
                        {authorName}
                      </p>
                      <div className="flex justify-between items-center">
                        <p className="text-black caveat">
                        ...
                        <div className="flex justify-end items-center">
                          <a
                            ...
                            className=" text-black text-[25px] caveat font-normal mr-2"
                          >
                            Details
                          </a>
                          <CgArrowLongRight className="text-[30px]  text-black" />
                        </div>
                      </div>
                    </div>
                  </div>
  ...
  return (
    <div className="flex justify-between lg:m-10 mx-10 my-5 ">
      <div className="hidden lg:block w-[18%] bg-white p-8 rounded-lg shadow-lg">
        <h2 className="text-center lg:text-[25px] md:text-[25px] uppercase font-bold caveat text-black mb-4">
          Categories
        </h2>
        {categoriseGenre()}
      </div>
