  ...
  return (
    <div className="sm:m-10 mx-10 mb-10 mt-0 lg:px-32 md:px-20 px-10 md:pt-32 pt-20 pb-0 sm:pb-16 lg:flex lg:flex-row md:flex md:flex-col flex flex-col justify-center items-center bg-white rounded-lg shadow-lg">
      ...
      <div className="lg:pl-16 pl-0 w-full  lg:mt-[-50px] mt-10 lg:w-[50%]">
        <p className="font-thin lg:text-[60px] md:text-[40px] text-[30px] lilita text-black">
          Find Your Favourite Book Here
        </p>
        <p className="lg:text-[20px] text-[15px] caveat text-black font-light">
        ...
        <div className="flex justify-between items-center">
          <div className="text-start caveat text-black">
        ...
        <NavLink to="/books">
          <button className="shadow-[10px_10px_10px_0px_rgba(0,0,0,0.25)] btn btn-md border-[2px] group hover:border-[#8387162] uppercase caveat font-semibold my-12 hover:bg-[#837162]  hover:text-[#fef5e6]  text-black text-[15px]">
            Find Your Favourite
