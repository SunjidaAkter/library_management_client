        ...
        <div className="card lg:card-side bg-white lg:flex lg:flex-row flex flex-col justify-between items-center rounded-lg lg:mx-10 mx-10 shadow-xl py-[50px] lg:px-[200px] px-0  sm:px-0">
          {filteredUserAccount?.image_url ? (
            ...
            <figure className="rounded-full">
              <AiOutlineUserAdd className="lg:h-[300px] lg:w-[300px] md:w-[300px] md:h-[300px] w-[200px] h-[200px] text-black rounded-full border-[5px] border-[#837162]" />
            </figure>
          )}

          <div className="lg:w-[50%] lg:ml-10 mt-5 lg:mt-0">
            <h2 className="mb-3 text-[40px] lg:text-[60px] font-bold caveat text-black">
            ...
            <p className="mb-3 text-[20px] lg:text-[25px] caveat">
              ...
              <span className="text-black">{user?.email || "LOADING..."}</span>
            </p>
            ...
            {/* <div className="lg:flex lg:justify-start md:flex md:justify-center flex justify-center">
              <button
                ...
                className="shadow-[10px_10px_10px_0px_rgba(0,0,0,0.25)] btn btn-md border-[2px] group hover:border-[#8387162] uppercase caveat font-semibold mt-4 hover:bg-[#837162]  hover:text-[#fef5e6]  text-black text-[20px]"
              >
                Edit Profile
                <CgArrowLongRight className="text-[30px] group-hover:text-[#fef5e6] text-black" />
              </button>
            </div> */}
          </div>
        </div>
      ...
      return (
        <table className="table-auto mx-auto w-full sm:w-[90%] lg:w-[70%] px-2 sm:px-5 rounded-lg mt-8 border dark:border-neutral-500">
          <thead className="bg-purple-900 text-white text-left">
            <tr className="bg-gradient-to-tr from-[black] to-[black] rounded-md py-1 sm:py-2 px-2 sm:px-4 text-white font-bold">
          ...
          <tbody className="caveat text-xs sm:text-[16px] md:text-[20px]">
                    ...
                    <button
                      ...
                      className={`${
                        borrow?.borrow_status === "Returned"
                          ...
                          : "border-2 border-[black] text-[black] px-3 py-1 sm:py-2 font-bold rounded-xl mx-auto w-full"
                      }`}
            ...
            <tr className="bg-black md:block hidden text-white">
              <th className="px-2 sm:px-4 py-1 sm:py-2 text-right" colSpan={6}>
                Current Balance
              </th>
              <th className="px-2 sm:px-4 py-1 sm:py-2 text-left">
  ...
  return (
    <div>
      ...
      <div className="m-10 py-3 px-4 bg-white rounded-xl shadow-md">
        <h1 className="font-bold caveat text-[50px] text-center pb-2 pt-2 text-black">
          Borrowing History
        </h1>
        <hr />
        <div className="overflow-x-auto">{categoriseTable()}</div>
        <p className="my-2 caveat text-center text-xs sm:text-[16px] md:text-[20px]">
