      ...
      return (
        <table className="table-auto mx-auto w-[90%] px-5 rounded-lg mb-10 mt-8 border dark:border-neutral-500">
          <thead className="bg-purple-900 text-white text-left">
            <tr className="bg-gradient-to-tr from-[black] to-[black] rounded-md py-2 px-4 text-white font-bold">
                ...
                <tr key={book?.id} className="border-b dark:border-neutral-500">
                  ...
                  <td className="px-4 py-2 ">
                    <button
                      ...
                      className="border-2 border-[black] text-[black] px-3 py-2 font-bold rounded-xl mx-auto w-[100%]"
  ...
  return (
    <div className="w-full ">
      <div className="mx-10 px-4 bg-white rounded-xl shadow-md">
        <h1 className="font-bold caveat lg:text-[50px] text-[30px] text-center pb-2 pt-2 text-black">
          Book Management
        </h1>
        <hr />
