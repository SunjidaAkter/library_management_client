    ...
    >
      {loading ? (
        ...
        >
          ...
          <p className="text-[black] sm:text-[100px] text-[50px] caveat">
            Loading...
          </p>
        ...
        <>
          ...
          <div className="drawer lg:drawer-open">
            ...
            <div className="drawer-content flex flex-col items-center justify-center relative">
              ...
              <label
                htmlFor="my-drawer-2"
                className="font-semibold drawer-button lg:hidden text-center mt-[-30px] text-[20px] caveat p-2 shadow-2xl text-black rounded"
              >
                {" "}
                DashBoard Manubar
              </label>
