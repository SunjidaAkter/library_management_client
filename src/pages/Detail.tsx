      ...
      return (
        <div className="card lg:card-side bg-white lg:flex lg:flex-row md:flex md:flex-col flex flex-col justify-between items-center rounded-lg mx-10 shadow-[10px_10px_10px_0px_rgba(0,0,0,0.25)] py-[20px] lg:px-[150px] md:px-10 px-5">
          ...
          <div className="lg:w-1/2 w-full flex justify-start">
            <div className="w-[80%]">
              <p
                className="lg:text-[70px] text-[30px] lilita font-thin text-black"
              ...
              <p
                ...
                className="footer-title text-[25px]  text-black caveat mb-5"
              >
              ...
              {/* <p className="badge bg-black text-white text-sm py-5">Novel</p> */}
              ...
              <p className="mb-3 lg:text-lg text-sm text-[black]">
                <b>Borrow Price :</b>{" "}
              ...
              <button
                ...
                className={`${
                  borrowedBorrow
                    ...
                    : "shadow-[10px_10px_10px_0px_rgba(0,0,0,0.25)] md:btn md:btn-md btn btn-sm border-[2px] group hover:border-[#8387162] uppercase caveat font-semibold mt-4 hover:bg-[#837162]  hover:text-[#fef5e6]  text-black lg:text-[20px] text-[15px]"
                }
                  `}
              ...
              <button
                className={`${
                  borrowedBorrow
                    ...
                    : "lg:ml-8 ml-2 shadow-[10px_10px_10px_0px_rgba(0,0,0,0.25)] md:btn md:btn-md btn btn-sm border-[2px] group hover:border-[#8387162] uppercase caveat font-semibold mt-4 hover:bg-[#837162]  hover:text-[#fef5e6]  text-black lg:text-[20px] text-[15px]"
                }
                `}
                onClick={handleWishlist}
                // className="ml-8 shadow-[10px_10px_10px_0px_rgba(0,0,0,0.25)] btn btn-md border-[2px] group hover:border-[#8387162] uppercase caveat font-semibold mt-4 hover:bg-[#837162]  hover:text-[#fef5e6]  text-black text-[20px]"
    ...
    if (reviewLoading) {
      ...
      return (
        <div className="mb-[100px] mt-[80px] flex flex-col justify-center items-center">
          ...
          <p className="text-black text-2xl caveat text-center font-extrabold">
                ...
                <div className="lg:flex lg:flex-row flex flex-col justify-center ">
                  ...
                  <div className="lg:w-[70%] w-full lg:ml-10 ml-3 mt-5">
                    <div className="lg:flex lg:flex-row flex flex-col justify-between">
                      <p className="text-black text-[25px] caveat font-bold">
                        {account ? account?.user : "Loading..."}
                      </p>
                      <p className=" text-black lg:text-[25px] text-[15px] caveat font-thin footer-title">
                    ...
                    <p className=" text-black text-[35px] caveat font-medium">
                      {review?.title}
                    </p>
                    <p className=" text-black text-xl caveat font-thin">
                      {review?.body}
                    </p>
                  </div>
                </div>
      ...
      <div className="">
        <div className="bg-white m-10 rounded-lg">
          <div className="card-body pb-0 pt-9">
            <p className="lg:text-[46px] text-[25px] font-bold text-black text-center caveat">
            ...
            >
              <p className="text-[26px] font-medium text-black mb-5 text-center caveat">
                Give Ratings
              </p>
              <StarRating
              ...
              <div className="flex justify-center">
                <button className="shadow-[10px_10px_10px_0px_rgba(0,0,0,0.25)] btn btn-md border-[2px] group hover:border-[#8387162] uppercase caveat font-semibold px-20 mt-10 hover:bg-[#837162]  hover:text-[#fef5e6]  text-black text-[20px]">
                  Review
                </button>
              </div>
            </form>
        ...
        <div className="m-10 bg-white p-3 rounded-lg">
          <h5 className="lg:text-[46px] text-[25px] font-bold text-black mb-5 text-center mt-5 caveat">
