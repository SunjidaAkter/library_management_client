      ...
      return (
        <div className="card lg:card-side bg-white flex justify-between items-center rounded-lg lg:mx-10 mx-10 shadow-xl py-[50px] lg:px-[20px] px-0  sm:px-0 ">
            ...
            {filteredUserAccount?.image_url ? (
              <figure className="rounded-full">
                <img
                  ...
                  alt="Album"
                />
                {/* <AiOutlineUserAdd className="px-7 text-[300px] text-black rounded-full border-[5px] border-[#837162]" /> */}
                {/* <img
          ...
          /> */}
              ...
              <figure className="rounded-full">
                <AiOutlineUserAdd className="lg:w-[80%] lg:h-[80%] w-[250px] h-[250px] text-black rounded-full border-[5px] border-[#837162]" />
              </figure>
            )}
            <div className="lg:w-[50%] lg:ml-10 mt-5 lg:mt-0">
              <h2 className="mb-3 text-[40px] lg:text-[50px] font-bold caveat text-black">
