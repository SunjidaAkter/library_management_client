  ...
  return (
    <div className="w-full ">
      <div className="mx-10 py-3 px-4 bg-white rounded-xl shadow-md">
        <h1 className="font-bold caveat lg:text-[50px] text-[25px] text-center pb-5 pt-2 text-black">
          Add Book
        </h1>
        <hr />
        <form
          ...
          <div className="px-10 md:px-20 lg:px-28 lg:py-7 pb-4 pt-0">
            ...
            <label className="form-control w-full my-3 md:my-5">
              <input
                ...
                placeholder="Title"
                id="title"
                className="input input-bordered w-full border-dashed border-b-[2px] border-[black] bg-white border-x-0 focus:border-0 border-t-0"
              />
            </label>
            <label className="form-control w-full my-3 md:my-5">
              <textarea
                ...
                id="description"
                className="textarea textarea-bordered w-full  border-dashed border-b-[2px] border-[black] bg-white border-x-0 focus:border-0 border-t-0"
              />
            </label>
            <div className="flex justify-between items-center">
              <label className="form-control w-[47%] my-3 md:my-5">
                <select
                  id="genre"
                  //   multiple
                  className="select select-bordered  border-dashed border-b-[2px] border-[black] bg-white border-x-0 focus:border-0 border-t-0"
                >
            ...
            <div className="flex justify-center">
              <button
                type="submit"
                className="px-6 py-3 bg-black text-white caveat text-[25px] uppercase rounded-md"
              >
                Add
              </button>
            </div>
