...
const Navbar = () => {
  ...
  return (
    <div className="lg:mx-10 lg:my-5 mx-10 mb-5 mt-5  shadow-lg">
      <div className="navbar bg-white lg:px-12 px-5 rounded-lg caveat text-black">
        <div className="navbar-start">
          ...
          <div className="flex justify-start items-center">
            ...
            <NavLink to="/">
              <p className="font-bold lg:text-[30px] text-[15px] text-black">
                BOOKIT
              </p>
            </NavLink>
          </div>
        ...
        <div className="navbar-end">
          <div>
            {userToken && userId ? (
              ...
              <HiOutlineUserCircle
                onClick={() => toggleDropdown("auth")}
                className="text-[30px] text-black ml-3"
              />
            )}
          ...
          <div className="indicator" onClick={handleWishlist}>
            <span className="indicator-item bg-white border-[2px] border-[#615b51] text-black px-[7px] text-sm rounded-2xl">
              {wishlistLength || "0"}
            </span>
            <IoHeartOutline className="text-[30px] text-black ml-3" />
          </div>
        </div>
      </div>
    </div>
